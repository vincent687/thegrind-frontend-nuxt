...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    const setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
        ...
        const effect = new reactivity$1.ReactiveEffect(componentUpdateFn, () => queueJob(instance.update), instance.scope // track it in component's effect scope
        );
...
const require$$0$1 = /*@__PURE__*/getDefaultExportFromCjs(vue_cjs_prod);
...
export { require$$0$1 as r, serverRenderer as s, vue_cjs_prod as v };
