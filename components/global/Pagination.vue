<template>
  <div class="flex justify-center mt-32">
		...
		<!-- <ul class="flex pagination bg-white p-2 shadow-sm rounded"> -->
			...
			>
				<span
					class="rounded-full border border-grayOther-300 px-3 py-2 bg-blackOther-100 no-underline text-white cursor-not-allowed mx-2"
...
<script setup lang="ts">
  ...
  const { maxVisibleButtons,totalPages, total, perPage,currentPage, hasMorePages  } = toRefs(props);
